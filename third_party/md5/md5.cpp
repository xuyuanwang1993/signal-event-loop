...
char * aimy::Get_MD5_String(const void *buf,int buf_size)
{
...
char* aimy::MY_our_MD5Data(void const* data, unsigned dataSize, char* outputDigest) {
  MY_MD5Context ctx;
...
unsigned char* aimy::MY_our_MD5DataRaw(void const* data, unsigned dataSize,
...
////////// MY_MD5Context implementation //////////

MY_MD5Context::MY_MD5Context()
  : fBitCount(0) {
...
void MY_MD5Context::addData(unsigned char const* inputData, unsigned inputDataSize) {
...
void MY_MD5Context::end(char* outputDigest) {
...
void MY_MD5Context::finalize(unsigned char* outputDigestInBytes) {
...
////////// Implementation of the MD5 transform ("MY_MD5Context::transform64Bytes()") //////////
...
void MY_MD5Context::transform64Bytes(unsigned char const block[64]) {
